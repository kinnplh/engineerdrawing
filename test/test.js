...
QUnit.test("Another Function Test", function( assert ) {
    ...
    assert.equal(prettyDate(now, "2008/01/27 22:23:30"), "Yesterday");//Yersterday is correct!
    assert.equal(prettyDate(now, "2008/01/26 22:23:30"), "2 days ago"); //2 days ago is correct!
